...
def abn2gedtsv(abn, gedtsv, model_type):
    """
    original: the ABN corpus e.g. /home/alta/BLTSpeaking/ged-pm574/artificial-error/lib/abn-work/bne+tdt4.mlf
    ...
    # ------------ Work 1 ------------ #
    with open(abn, 'r') as file:
        lines = file.readlines()
    with open(myoutput[0], 'w') as file:
        for line in lines:
            if line == '#!MLF!#' or line[-6:] == '.lab"\n':
                continue
            if line == '.\n': # end of a sentence
                # file.write('.\n\n')
                file.write('\n')
    ...
    with open(myoutput[1], 'w') as file:
        for line in lines:
            ...
            # No mispronunciation in BBC subtitles
...
def main():
    if(len(sys.argv) != 2):
        print("Usage: python3 abn2gedtsv.py [unigram/bigram]")
        return
    ...
    path1 = "/home/alta/BLTSpeaking/ged-pm574/artificial-error/lib/abn-work/bne+tdt4.mlf"
    path2 = "/home/alta/BLTSpeaking/ged-pm574/artificial-error/lib/abn-work/abn7-3"
    abn2gedtsv(path1, path2, model_type)

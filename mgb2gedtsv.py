...
def mgb2gedtsv(mgb, gedtsv, model_type):
    """
    original: the MGB corpus e.g. /home/dawna/mgb3/transcription/convert/lib/wlabs/all.mlf
...
def main():
    if(len(sys.argv) != 2):
        print("Usage: python3 mgb2gedtsv.py [unigram/bigram]")
        return
    ...
    path1 = "/home/dawna/mgb3/transcription/convert/lib/wlabs/all.mlf"
    path2 = "/home/alta/BLTSpeaking/ged-pm574/artificial-error/lib/mgb-work/mgb7-2.bigram"
    mgb2gedtsv(path1, path2, model_type)
